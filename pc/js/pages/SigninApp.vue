    ...
    <div id="app" class="main">
        ...
        <div class="js-sign-in-container">
            ...
            <div class="more-sign">
                ...
                <ul>
                    <li>
                        <a class="github" target="_blank" href="/users/signin/github">
                    ...
                    <li><a class="weixin" target="_blank" href="/users/signin/weibo"><i class="iconfont ic-wechat"></i></a></li>
                    <li><a class="qq" target="_blank" href="/users/signin/weibo"><i class="iconfont ic-qq_connect"></i></a></li>
                    <li class=""><a class="weibo" target="_blank" href="/users/signin/weibo"><i class="iconfont ic-weibo"></i></a></li>
                </ul>
