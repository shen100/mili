    ...
    <div class="post-list-box">
        <div class="sub-header">
            ...
            <div class="sub-type-box">
                <router-link :to="`/uc/${author.id}/follows`" class="sub-type">关注了</router-link>
                <router-link :to="`/uc/${author.id}/followers`" class="sub-type active">粉丝</router-link>
                <router-link :to="`/uc/${author.id}/followtags`" class="sub-type">关注标签</router-link>
            </div>
        </div>
        <Pinterest :url="`/users/${author.id}/followers`" @load="onLoad">
            ...
            <template v-slot:content>
                <div>
                    <a :key="follower.id" :href="`/uc/${follower.id}`" v-for="follower in followers" target="_blank" class="link user-follow-item">
                        ...
                        <FollowBtn v-if="userID !== follower.id" :userID="follower.id" :followed="follower.isFollowed"></FollowBtn>
                    </a>
                </div>
            </template>
        </Pinterest>
