...
export default {
    ...
    data: function() {
        const readed = [
            ...
            'pc/js/components/admin/book/CreateChapterModal.vue',
            'pc/js/components/admin/book/CreateOrUpdateBookModal.vue',
            'pc/js/components/admin/book/CreateOrUpdateChapterModal.vue',
            'pc/js/components/admin/common/Header.vue',
            'pc/js/components/admin/common/User.vue',
            ...
            'pc/js/components/comment/CommentList.vue',
            'pc/js/components/comment/ReplyIcon.vue',
            'pc/js/components/comment/ZanIcon.vue',
            'pc/js/components/common/More.vue',

            'pc/js/components/common/sidemenu/CollapsedMenu.vue',
            'pc/js/components/common/sidemenu/CommonIcon.vue',
            'pc/js/components/common/sidemenu/Icons.vue',
            'pc/js/components/common/sidemenu/index.js',
            'pc/js/components/common/sidemenu/itemmixin.js',
            'pc/js/components/common/sidemenu/mixin.js',
            'pc/js/components/common/sidemenu/SideMenu.vue',
            'pc/js/components/common/sidemenu/SideMenuItem.vue',
            'pc/js/components/common/sidemenu/tools.js',
            'pc/js/components/common/sidemenu/util.js',

            'pc/js/components/common/Paging.vue',
            'pc/js/components/editor/BoilingPointEditor.vue',
            'pc/js/components/editor/CommentRichEditor.vue',
            'pc/js/components/editor/CommentRichEditorEmoji.vue',
            ...
            'pc/js/pages/admin/article/Crawler.vue',
            'pc/js/pages/admin/article/CrawlerList.vue',
            'pc/js/pages/admin/book/BookList.vue',
            'pc/js/pages/admin/book/EditBook.vue',
            'pc/js/pages/admin/exercise/EditQuestion.vue',
            'pc/js/pages/admin/exercise/QuestionList.vue',
            'pc/js/pages/admin/layout.vue',
            ...
            'pc/styles/admin/book/edit_book.scss',
            ...
            'src/boilingpoint/boilingpoint.module.ts',
            'src/boilingpoint/boilingpoint.service.ts',
            'src/boilingpoint/topic.admin.controller.ts',
            'src/boilingpoint/topic.controller.ts',
            'src/boilingpoint/topic.service.ts',
            ...
            'src/constants/exercise.ts',
            'src/core/middleware/cors.middleware.ts',
            'src/core/middleware/csrf.middleware.ts',
            'src/exercise/dto/edit-question.dto.ts',
            'src/exercise/dto/validation/AnswersValidator.ts',
            'src/exercise/dto/validation/OptionsValidator.ts',
            'src/exercise/exercise.module.ts',
            'src/exercise/question.controller.ts',
            'src/exercise/question.service.ts',

            'src/entity/comment.entity.ts',
            'src/entity/crawler.entity.ts',
            'src/entity/exercise.entity.ts',
            'src/entity/question.entity.ts',
            'src/entity/question.option.entity.ts',
